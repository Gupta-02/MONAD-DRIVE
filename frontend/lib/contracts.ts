...
import carPurchaseRegistryJson from "./abi/CarPurchaseRegistry.json";
...
const CAR_PURCHASE_REGISTRY_ADDRESS = (process.env.NEXT_PUBLIC_CAR_PURCHASE_REGISTRY_ADDRESS || "0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512") as `0x${string}`;
...
export const carPurchaseRegistryAbi = carPurchaseRegistryJson;
export const carPurchaseRegistryAddress = CAR_PURCHASE_REGISTRY_ADDRESS;
